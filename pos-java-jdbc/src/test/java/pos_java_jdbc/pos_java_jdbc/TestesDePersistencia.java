...
public class TestesDePersistencia {
	...
	public static void main(String[] args) {
		...
		/*
		 * PersistenciaDeDadosSql persistenciaDeDadosSqlCriarDados = new
		 * PersistenciaDeDadosSql(); DadosPessoas dadosPessoas = new DadosPessoas();
		 * 
		 * //"Setar os atributos para criar o registro na tabela"
		 * //dadosPessoas.setId(5L); dadosPessoas.setNome("Bruno Yago Moreira");
		...
		/*
		 * PersistenciaDeDadosSql persistenciaDeDadosSqlListar = new
		 * PersistenciaDeDadosSql(); try {
		 * 
		 * List<DadosPessoas> ListaDeRegistros =
		 * persistenciaDeDadosSqlListar.consultarRegistros();
		 * 
		 * for (DadosPessoas dadosPessoas : ListaDeRegistros) {
		 * System.out.println(dadosPessoas.toString()); System.out.println("\n"); }
		 * 
		 * } catch (Exception e) { }
		 */
		...
		/*
		 * PersistenciaDeDadosSql persistenciaDeDadosSqlUmDadoPorVez = new
		 * PersistenciaDeDadosSql();
		 * 
		 * try {
		 * 
		 * DadosPessoas dadosPessoasUmPorVez =
		 * persistenciaDeDadosSqlUmDadoPorVez.retornarRegistros(2L);
		...
		/*
		 * try { PersistenciaDeDadosSql persistenciaDeDadosSqlAtualizar = new
		 * PersistenciaDeDadosSql();
		 * 
		 * /* Instância o objeto do tipo DadosPessoas que recebe o método
		 * retornarRegistro e passamos o parâmetro o id do registro da tabela para
		 * atualizar os dados de registro da tabela.
		 */
		/*
		 ...
		 * o objeto consultarRegistro como parâmetro que armazena o valor do id passado
		 * pelo usuário.
		 */
		...
		/*try {
			...
			persistenciaDeDadosSqlDeletar.deletar(1L);
		...
		// <<------- EXECUTA O MÉTODO Tabela Curso (DELETE) REGISTRO TABELA------->>
		 Curso curso = new Curso();
		 curso.setCurso("Oracle Cloud");
		 curso.setTipo("Infraestrutura na nuvem (devops)");
		 curso.setIdprimario(10L);
		 
		 PersistenciaDeDadosSql persistenciaDeDadosSql = new PersistenciaDeDadosSql();
		 persistenciaDeDadosSql.criarRegistroCurso(curso);
	}
}
